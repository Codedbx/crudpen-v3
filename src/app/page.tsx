...
export default function Home() {
  ...
  return (
    <div className="relative w-full flex flex-col items-center overflow-hidden">
      ...
      {/* HERO SECTION */}
      <section className="relative w-full flex flex-col items-center justify-center text-center px-6 md:px-8 pt-24 pb-16 z-10">
        ...
        <Link
          href="/projects"
          className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-foreground/20 bg-gradient-to-r from-violet-100/95 via-fuchsia-50/90 to-rose-50/80 dark:from-brand-primary/12 dark:via-brand-primary/6 dark:to-transparent text-sm font-normal text-foreground/80 hover:border-brand-primary/30 transition-colors duration-300 mb-6"
        >
          <span>We offer the best services.</span>
          <ArrowRight className="h-3.5 w-3.5 shrink-0 text-foreground/55" strokeWidth={1.75} />
        </Link>

        {/* Main Heading with Flip Words */}
        <h1 className="text-4xl md:text-7xl font-bold tracking-tight text-foreground max-w-4xl leading-[1.1] mb-6">
          Bringing your{' '}
          <FlipWords
        ...
        <p className="text-sm md:text-base text-muted-foreground max-w-2xl leading-relaxed mb-10">
          We build high-quality websites, mobile apps, and digital solutions to help businesses
          grow. Our goal is to create seamless, user-friendly experiences that drive success.
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 mb-16">
          ...
          <AnimatedButton href="/projects" variant="secondary" icon={ArrowUpRight}>
            Explore Project
          </AnimatedButton>
        </div>
        ...
        {/* Partner Logos */}
        <div className="w-full max-w-4xl flex flex-wrap items-center justify-center gap-10 md:gap-20 opacity-50">
          <span className="text-foreground text-lg font-bold tracking-tight uppercase flex items-center gap-1"><div className="w-4 h-4 bg-white/20 rounded-sm"></div> slack</span>
          <span className="text-foreground text-lg font-black tracking-tighter lowercase">amazon</span>
          <span className="text-foreground text-lg font-bold tracking-widest text-red-500 uppercase">Netflix</span>
          <span className="text-foreground text-lg font-bold tracking-tight lowercase text-blue-400">Google</span>
          <span className="text-foreground text-lg font-black tracking-tight flex items-center gap-1"><div className="w-5 h-4 bg-brand-primary/40 rounded-sm"></div> Discord</span>
        </div>
      </section>
      ...
      <section className="w-full max-w-7xl mx-auto px-6 md:px-8 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center z-10 relative">
        <div className="flex flex-col text-left relative">
          ...
          <p className="text-muted-foreground leading-relaxed text-sm mb-8 max-w-lg">
            At Crudpen, we engineer custom software architectures designed to solve structural business inefficiencies. We create modular database layers, optimize cloud structures, and ship spectacular user interfaces that convert users at record scale.
          </p>
          
          <AnimatedButton href="/about" variant="primary" icon={ArrowRight} className="mb-16">
            Explore More
          </AnimatedButton>
          ...
          <div className="h-32 w-32 rounded-full bg-brand-primary flex flex-col items-center justify-center text-black shadow-[0_0_30px_rgba(125,42,232,0.3)] border-4 border-background self-start ml-8 md:ml-12 z-20 hover:scale-105 transition-transform duration-300">
            <span className="text-3xl font-black leading-none tracking-tight">150+</span>
            <span className="text-[8px] font-bold uppercase tracking-widest mt-1 opacity-80 text-center px-2">Systems Shipped</span>
          </div>
        </div>
        ...
        <div className="relative w-full h-[500px] flex items-center justify-center lg:justify-end mt-12 lg:mt-0">
          ...
          <div className="relative w-[85%] h-[90%] rounded-3xl overflow-hidden shadow-2xl border border-border z-10">
            <Image src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?q=80&w=1000&auto=format&fit=crop" alt="Team meeting" fill className="object-cover" />
          ...
          <div className="absolute left-[5%] bottom-[10%] h-24 w-24 rounded-full glass border-2 border-brand-primary/50 flex items-center justify-center text-foreground shadow-[0_0_20px_rgba(125,42,232,0.2)] z-20 backdrop-blur-md hover:border-brand-primary transition-colors duration-300">
            <div className="flex flex-col items-center justify-center">
              <span className="text-[8px] uppercase tracking-widest text-brand-primary font-bold mb-1">Code Quality</span>
      ...
      <section className="w-full bg-card/80 py-24 border-y border-border relative z-10">
        <div className="max-w-7xl mx-auto px-6 md:px-8 text-center mb-16">
          <span className="text-[10px] uppercase tracking-[0.2em] text-brand-primary font-bold mb-3 block">OUR EXPERTISE</span>
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-foreground mb-4 leading-tight">
            Smart Services For <span className="text-brand-primary">Digital Growth</span>
          </h2>
          <p className="text-muted-foreground text-sm max-w-xl mx-auto leading-relaxed">
            We cover the entire lifecycle of software engineering, providing modern tooling and top-tier capabilities.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center max-w-7xl mx-auto px-6 md:px-8">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="glass-glow rounded-2xl p-6 hover:-translate-y-1 transition-transform duration-300 flex flex-col gap-4 border-brand-primary/10 group">
              ...
              <h3 className="text-lg font-bold text-foreground group-hover:text-brand-primary transition-colors">Automation Systems</h3>
              <p className="text-muted-foreground text-xs leading-relaxed">
                Integrating AI automation, large language models, and robust APIs directly into your core business flows.
              </p>
              <Link href="/services" className="text-[10px] font-bold text-brand-primary hover:underline flex items-center gap-1">
            ...
            <div className="glass-glow rounded-2xl p-6 hover:-translate-y-1 transition-transform duration-300 flex flex-col gap-4 border-brand-primary/10 group">
              ...
              <h3 className="text-lg font-bold text-foreground group-hover:text-brand-primary transition-colors">Fullstack Architecture</h3>
              <p className="text-muted-foreground text-xs leading-relaxed">
                Building highly dynamic websites, portals, and platforms using React, Next.js, and TypeScript.
              </p>
              <Link href="/services" className="text-[10px] font-bold text-brand-primary hover:underline flex items-center gap-1">
                Read More <ArrowUpRight className="h-3 w-3" />
              </Link>
          ...
          <div className="relative flex justify-center items-center py-12 lg:py-0 w-full h-[600px] rounded-3xl overflow-hidden shadow-2xl border border-border">
            <Image src="https://images.unsplash.com/photo-1573164713988-8665fc963095?q=80&w=800&auto=format&fit=crop" alt="Woman smiling" fill className="object-cover opacity-80" />
              ...
              <div className="w-full h-full rounded-[38px] bg-[#0a0c10] border border-border overflow-hidden p-4 pt-8 flex flex-col gap-4 text-left relative">
                <div className="relative z-10 flex flex-col gap-4 h-full">
                  <div className="flex items-center justify-between">
                    <span className="text-[9px] text-muted-foreground font-bold uppercase tracking-wider">Analytics Dashboard</span>
                    <div className="h-4 w-4 rounded-full bg-brand-primary/20 flex items-center justify-center text-brand-primary">
                      <Zap className="h-2 w-2" />
                    </div>
                  </div>
                  <div>
                    <span className="text-[10px] text-muted-foreground block font-medium mb-1">Total Systems Revenue</span>
                    <span className="text-2xl font-black text-foreground">$148,259.00</span>
                  </div>
                  ...
                  <div className="h-24 bg-card rounded-xl border border-border relative p-2 overflow-hidden flex items-end justify-between gap-1 mt-2">
                    <div className="absolute top-2 left-2 text-[8px] text-muted-foreground font-bold uppercase tracking-wider">System Threads</div>
                  ...
                  <div className="flex flex-col gap-2 mt-4">
                    <span className="text-[9px] text-muted-foreground font-bold uppercase tracking-widest">Active API streams</span>
                    <div className="flex items-center justify-between p-2.5 rounded-lg bg-card text-[9px] border border-border">
                      <span className="text-foreground/80 font-medium text-xs">Stripe Webhook</span>
                      <span className="text-brand-primary font-bold flex items-center gap-1.5 bg-brand-primary/10 px-2 py-1 rounded-md">
                        <div className="h-1.5 w-1.5 rounded-full bg-brand-primary animate-pulse" /> Online
                      </span>
                    </div>
                    <div className="flex items-center justify-between p-2.5 rounded-lg bg-card text-[9px] border border-border">
                      <span className="text-foreground/80 font-medium text-xs">LLM completion</span>
                      <span className="text-brand-primary font-bold flex items-center gap-1.5 bg-brand-primary/10 px-2 py-1 rounded-md">
                        <div className="h-1.5 w-1.5 rounded-full bg-brand-primary animate-pulse" /> Online
                      </span>
                    </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="glass-glow rounded-2xl p-6 hover:-translate-y-1 transition-transform duration-300 flex flex-col gap-4 border-brand-primary/10 group">
              ...
              <h3 className="text-lg font-bold text-foreground group-hover:text-brand-primary transition-colors">Cloud Architecture</h3>
              <p className="text-muted-foreground text-xs leading-relaxed">
                Deploying serverless systems across AWS, GCP, and Azure with ironclad CI/CD pipelines.
              </p>
              <Link href="/services" className="text-[10px] font-bold text-brand-primary hover:underline flex items-center gap-1">
                Read More <ArrowUpRight className="h-3 w-3" />
              </Link>
            ...
            <div className="glass-glow rounded-2xl p-6 hover:-translate-y-1 transition-transform duration-300 flex flex-col gap-4 border-brand-primary/10 group">
              ...
              <h3 className="text-lg font-bold text-foreground group-hover:text-brand-primary transition-colors">SEO & Performance</h3>
              <p className="text-muted-foreground text-xs leading-relaxed">
                Ensuring lightning-fast page loading speeds and highly optimized search engines index coverage.
              </p>
              <Link href="/services" className="text-[10px] font-bold text-brand-primary hover:underline flex items-center gap-1">
                Read More <ArrowUpRight className="h-3 w-3" />
              </Link>
      ...
      <section className="w-full py-24 max-w-7xl mx-auto px-6 md:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col text-left">
            <span className="text-[10px] uppercase tracking-[0.2em] text-brand-primary font-extrabold mb-4 block">OUR WORKING METHOD</span>
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-foreground mb-10 leading-tight">
              Our Process, <br />Your <span className="text-brand-primary drop-shadow-[0_0_10px_rgba(125, 42, 232,0.25)]">Solution</span>
            </h2>
            ...
            <div className="flex flex-col gap-8">
              <div className="flex gap-4 group">
                ...
                <div>
                  <h3 className="text-base font-bold text-foreground mb-1 group-hover:text-brand-primary transition-colors">Deep Discovery & Blueprint</h3>
                  <p className="text-muted-foreground text-xs leading-relaxed">
                    We deep-dive into your operational pipeline to draft system specifications and technical blueprints.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 group">
                ...
                <div>
                  <h3 className="text-base font-bold text-foreground mb-1 group-hover:text-brand-primary transition-colors">Modular System Spec</h3>
                  <p className="text-muted-foreground text-xs leading-relaxed">
                    Structuring databases, user hierarchies, and API endpoints, establishing absolute project clarity before coding.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 group">
                ...
                <div>
                  <h3 className="text-base font-bold text-foreground mb-1 group-hover:text-brand-primary transition-colors">Bespoke Engineering</h3>
                  <p className="text-muted-foreground text-xs leading-relaxed">
                    Our engineering experts develop the software platform, using clean, modular, and fully tested TypeScript codebases.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="relative h-[500px] lg:h-[600px] w-full flex items-center justify-center">
            ...
            <div className="absolute right-0 top-10 w-[70%] h-[60%] rounded-3xl overflow-hidden shadow-2xl border border-border rotate-[5deg] hover:rotate-0 transition-transform duration-500 z-10">
              <Image src="https://images.unsplash.com/photo-1552581234-26160f608093?q=80&w=800&auto=format&fit=crop" alt="Man smiling" fill className="object-cover opacity-90" />
            ...
            <div className="absolute left-4 bottom-10 w-[65%] h-[55%] rounded-3xl overflow-hidden shadow-2xl border border-border -rotate-[3deg] hover:rotate-0 transition-transform duration-500 z-20">
              <Image src="https://images.unsplash.com/photo-1551434678-e076c223a692?q=80&w=800&auto=format&fit=crop" alt="Dashboard" fill className="object-cover opacity-90" />
              ...
              <div className="absolute top-4 right-4 h-20 w-20 rounded-full glass border border-brand-primary/30 flex items-center justify-center shadow-[0_0_30px_rgba(125,42,232,0.4)] animate-pulse-slow backdrop-blur-md">
                <div className="flex flex-col items-center">
                  <span className="text-brand-primary font-black text-lg leading-none">100%</span>
                  <span className="text-[7px] text-foreground/80 uppercase tracking-widest font-bold mt-1">Score</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="w-full bg-card/40 py-24 border-t border-border relative z-10">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-16 gap-6">
            <div>
              <span className="text-[10px] uppercase tracking-[0.2em] text-brand-primary font-extrabold mb-4 block">CASE STUDIES</span>
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-foreground leading-tight">
                Discover Our <br />Recent Work
              </h2>
            </div>
            <AnimatedButton href="/projects" variant="inverse" size="sm" icon={ArrowUpRight}>
              Explore Projects
            </AnimatedButton>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            ...
            <div className="relative h-64 md:h-80 rounded-3xl overflow-hidden shadow-lg opacity-60 hover:opacity-100 transition-opacity duration-500 hidden md:block">
              <Image src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=800&auto=format&fit=crop" alt="Case study 1" fill className="object-cover" />
            ...
            <div className="relative h-80 md:h-96 rounded-3xl overflow-hidden shadow-[0_0_40px_rgba(125,42,232,0.15)] md:scale-110 z-20 group transition-transform duration-500 border border-brand-primary/20">
              ...
              <Image src="https://images.unsplash.com/photo-1551434678-e076c223a692?q=80&w=800&auto=format&fit=crop" alt="Case study 2" fill className="object-cover" />
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white rounded-2xl p-4 text-center shadow-2xl z-20 hover:-translate-y-1 transition-transform duration-300 cursor-pointer">
                <h3 className="text-sm font-black text-black mb-1">Virtual Workspace</h3>
                <span className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider block">Read case study</span>
              </div>
            </div>

            {/* Right Card - Faded Image */}
            <div className="relative h-64 md:h-80 rounded-3xl overflow-hidden shadow-lg opacity-60 hover:opacity-100 transition-opacity duration-500 hidden md:block">
              <Image src="https://images.unsplash.com/photo-1553877522-43269d4ea984?q=80&w=800&auto=format&fit=crop" alt="Case study 3" fill className="object-cover" />
              <div className="absolute inset-0 bg-brand-primary/40 mix-blend-overlay" />
              <div className="absolute inset-0 bg-zinc-950/40" />
            </div>
          </div>
      ...
      <section className="w-full bg-card/90 py-24 border-y border-border relative z-10">
        <div className="max-w-7xl mx-auto px-6 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative flex justify-center lg:justify-start items-center">
            ...
            <div className="relative w-72 h-72 md:w-96 md:h-96 rounded-full overflow-hidden border-8 border-card shadow-[0_0_50px_rgba(125,42,232,0.15)] z-10">
              <Image src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=800&auto=format&fit=crop" alt="Expertise" fill className="object-cover" />
            </div>
          ...
          <div className="text-left flex flex-col items-start">
            <span className="text-[10px] uppercase tracking-[0.2em] text-brand-primary font-extrabold mb-4 block">OUR DOMAIN EXPERTISE</span>
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-foreground mb-10 leading-tight">
              Deep Expertise in Cutting<br />Edge Software Solutions
            </h2>
            ...
            <div className="flex flex-wrap gap-8 text-center mb-10">
              ...
              <div className="flex flex-col items-center gap-3 group">
                <div className="relative h-20 w-20 flex items-center justify-center">
                  ...
                  <span className="text-sm font-black text-foreground relative z-10">99%</span>
                </div>
                <span className="text-[9px] uppercase tracking-widest text-muted-foreground font-bold">UI Design</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-3 group">
                <div className="relative h-20 w-20 flex items-center justify-center">
                  ...
                  <span className="text-sm font-black text-foreground relative z-10">95%</span>
                </div>
                <span className="text-[9px] uppercase tracking-widest text-muted-foreground font-bold">Development</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-3 group">
                <div className="relative h-20 w-20 flex items-center justify-center">
                  ...
                  <span className="text-sm font-black text-foreground relative z-10">89%</span>
                </div>
                <span className="text-[9px] uppercase tracking-widest text-muted-foreground font-bold">Analytics</span>
              </div>
            </div>

            <AnimatedButton href="/services" variant="outline" icon={ArrowUpRight}>
              Explore More
            </AnimatedButton>
          </div>
        </div>
      ...
      <section className="w-full max-w-7xl mx-auto px-6 md:px-8 py-24 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center text-left mb-24">
          ...
          <div className="flex flex-col gap-10">
            <div>
              <span className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground font-bold mb-4 block">TESTIMONIALS</span>
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-foreground leading-tight">
                When Our Clients Say<br />Results From Clients
              </h2>
            </div>
            ...
            <div className="relative w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-brand-primary/20 shadow-[0_0_30px_rgba(125,42,232,0.15)] ml-4">
              <Image src="https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=400&auto=format&fit=crop" alt="Client" fill className="object-cover" />
              ...
              <div className="absolute -left-2 top-1/2 -translate-y-1/2 h-14 w-14 rounded-full bg-brand-primary flex items-center justify-center shadow-[0_0_20px_rgba(125,42,232,0.5)] border-4 border-background z-20">
                <span className="text-black font-serif text-3xl font-bold pt-2">“</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6 lg:pl-10 relative">
            ...
            <p className="text-foreground/90 text-lg md:text-xl leading-relaxed font-medium italic relative z-10">
              "Crudpen delivered our central SaaS management board ahead of deadline. The system handles 50k+ active threads without a single performance dip. Highly recommended team."
            </p>
            
            <div className="flex items-center gap-4 mt-4">
              <div className="h-12 w-12 rounded-full overflow-hidden border border-brand-primary/30 relative hidden md:block">
                <Image src="https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=200&auto=format&fit=crop" alt="Alexander Harris" fill className="object-cover" />
              </div>
              <div>
                <h4 className="text-base font-bold text-foreground">Alexander Harris</h4>
                <p className="text-[10px] text-brand-primary uppercase tracking-widest font-bold">VP of Product, SaaS Analytics</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-16 gap-4">
            <div className="text-left">
              <span className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground font-bold mb-4 block">BLOG & INSIGHTS</span>
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-foreground leading-tight">
                News Updates And <span className="text-brand-primary">Expert Advice</span>
              </h2>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
            ...
            <div className="glass-glow rounded-3xl overflow-hidden border-brand-primary/10 hover:border-brand-primary/30 transition-colors duration-300 group flex flex-col">
              <div className="h-56 w-full relative overflow-hidden">
                <Image src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?q=80&w=800&auto=format&fit=crop" alt="Blog post 1" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                ...
                <div className="absolute top-4 left-4 bg-white text-black px-3 py-2 rounded-xl shadow-lg z-10 flex flex-col items-center">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Oct</span>
              ...
              <div className="p-8 flex flex-col flex-grow bg-card">
                ...
                <p className="text-muted-foreground text-sm mb-6 flex-grow leading-relaxed">
                  An in-depth analysis of when to adopt distributed systems and when a well-structured monolith is the superior choice.
                </p>
            ...
            <div className="glass-glow rounded-3xl overflow-hidden border-brand-primary/10 hover:border-brand-primary/30 transition-colors duration-300 group flex flex-col">
              <div className="h-56 w-full relative overflow-hidden">
                <Image src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=800&auto=format&fit=crop" alt="Blog post 2" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                <div className="absolute inset-0 bg-brand-primary/10 mix-blend-overlay pointer-events-none" />
                {/* Floating Date Badge */}
                <div className="absolute top-4 left-4 bg-white text-black px-3 py-2 rounded-xl shadow-lg z-10 flex flex-col items-center">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Sep</span>
              ...
              <div className="p-8 flex flex-col flex-grow bg-card">
                ...
                <p className="text-muted-foreground text-sm mb-6 flex-grow leading-relaxed">
                  Frameworks for maintaining code quality and architectural integrity while rapidly expanding your engineering organization.
                </p>
                <div className="flex items-center mt-auto">
                  <AnimatedButton href="#" variant="soft" icon={ArrowRight}>
                    Read Article
      ...
      <section className="w-full py-24 max-w-7xl mx-auto px-6 md:px-8 relative z-10">
        <div className="glass-glow rounded-3xl p-12 md:p-16 border-brand-primary/20 relative overflow-hidden text-center flex flex-col items-center justify-center shadow-[0_0_50px_rgba(125, 42, 232,0.04)]">
          ...
          <span className="text-[10px] uppercase tracking-[0.22em] text-brand-primary font-extrabold mb-4 block">READY TO COMMENCE?</span>
          
          <h2 className="text-4xl md:text-7xl font-black text-foreground mb-8 tracking-tight uppercase leading-none select-none">
            LET US BUILD <br />
            <span className="text-brand-primary drop-shadow-[0_0_15px_rgba(125, 42, 232,0.35)]">TOGETHER</span>
          </h2>
          
          <AnimatedButton href="/contact" variant="primary" size="lg" icon={ArrowUpRight} glow>
