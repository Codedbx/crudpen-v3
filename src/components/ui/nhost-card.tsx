...
import "./nhost-card.css";

export const NhostCard = () => {
  return (
    <div className="nhost-card">
      ...
      <div className="card-header">
        <div className="brand-wrapper">
          ...
          <span className="brand-text">NHOST</span>
        </div>
      ...
      <div className="card-body">
        <div className="repo-title">
          nhost-js<span className="blinking-cursor"></span>
        </div>
        <p className="repo-description">
          The ultra-lightweight JavaScript SDK for interacting with the Nhost
          stack.
        </p>
